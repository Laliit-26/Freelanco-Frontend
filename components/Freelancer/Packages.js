...
const Packages = ({ register, control, setValue }) => {
  ...
  return (
    <div>
      <div className="bg-gray-900 rounded-lg shadow-md w-1/2 justify-between">
        <div className="flex justify-between w-full">
          <button
            className={`${
              selectedTab === 0 ? "bg-gray-400" : ""
            } text-gray-700 font-medium py-2 px-4 rounded-l-lg hover:bg-gray-900 focus:outline-none`}
          ...
          <button
            ...
            } text-gray-700 font-medium py-2 px-4 hover:bg-gray-900 focus:outline-none`}
          ...
          <button
            ...
            } text-gray-700 font-medium py-2 px-4 rounded-r-lg hover:bg-gray-900 focus:outline-none`}
