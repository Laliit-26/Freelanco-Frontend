          ...
          {counter === 0 && (
            <>
              ...
              <div className="flex w-full mt-5 justify-end items-end">
                <button
                  className="bg-blue-800 p-4 shadow-sm rounded-3xl text-md text-white px-8"
          ...
          {counter === 1 && (
            <>
              ...
              <div className="flex justify-between items-start w-full">
                ...
                <div className="max-w-[calc(20vw)] py-4 px-8 shadow-lg rounded-lg mt-2 bg-blue-400 flex-1/4 text-white">
                  <div>
              ...
              <div className="flex w-full h-32 justify-end items-end">
                <button
                  className="bg-blue-800 p-4 shadow-sm rounded-3xl text-md text-white px-8 mr-2"
                  onClick={() => {
                    setCounter((prevState) => prevState - 1);
                  }}
                >
              ...
              <ReactSelect
                ...
                styles={{
                  control: (baseStyles, state) => ({
                    ...baseStyles,
                    borderColor: state.isFocused ? "#0F1D3A" : "#0F1D3A",
                    backgroundColor: "#0F1D3A",
                  }),
                  option: (provided, state) => ({
                    ...provided,
                    backgroundColor: state.isSelected ? "#0F1D3A" : "#fff",
                ...
                className="block w-full text-black rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-black"
              />
            ...
            <>
              ...
              <div className="flex space-x-16 w-full">
                <div
                  className={
                    (isShortTermSelected
                      ? "h-48 w-1/2 border-2 shadow-md border-blue-900 bg-blue-900"
                ...
                >
                  <img src="clo.png" alt="" className="w-16 h-16" />
                ...
                <div
                  className={
                    (isShortTermSelected === false
                      ? "h-48 w-1/2 border-2 shadow-md border-blue-200 bg-blue-900 "
                      : "h-48 w-1/2 border-2 shadow-md ") +
                    " flex justify-center hover:bg-blue-200 cursor-pointer transition ease-in-out delay-50 rounded-3xl items-center flex-col"
                  }
                  onClick={() => {
                ...
                <button
                  className={
                    loading
                      ...
                      : "bg-blue-800 p-4 shadow-sm rounded-3xl text-md text-white w-32"
                  }
                  onClick={async () => {
